...
## 🎯 Project Overview
**Jarrelix Student Accommodation** is a **full-stack web application** for managing student housing at University of Limpopo (UL). It handles room applications, document verification, payments, ratings, announcements, and admin management.
